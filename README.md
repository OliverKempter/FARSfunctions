...
<!-- badges: start -->
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/githubgithub/oliverkempter/farsfunctions/master?svg=true)](https://ci.appveyor.com/projects/status/githubgithub/oliverkempter/farsfunctions/master?svg=true)
<!-- badges: end -->
