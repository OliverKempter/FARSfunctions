...
<!-- badges: start -->
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/githubgithub/oliverkempter/farsfunctions)](https://ci.appveyor.com/projects/status/githubgithub/oliverkempter/farsfunctions)
<!-- badges: end -->
